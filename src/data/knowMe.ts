...
export const knowMeCards: KnowMeCard[] = [
  ...
  },
  {
    ...
    description: "Programming is both my profession and my first and only hobby for a long time. I see it as giving purpose to a piece of rock; not just making things work, but making them feel right.",
    primaryActionLabel: "View Projects",
    primaryActionUrl: "https://projects.nalamzap.dev",
    order: 3
  },
  {
    id: "card_4",
    ...
    imageUrl: "https://unsplash.com/photos/book-lot-on-table-9BoqXzEeQqM",
